<?php
	/*
		file: app/daemon/inc/twitter.php
		desc: update server (daemon) => twitter dbupdate function
	*/
	...
	function dbupdate() {
		...
		$sources = $mod_db->query( '
			SELECT user_id, auth_data, type, 0 AS id, update_time, o_id, latest_tweet_id AS since_id
			FROM mod_account
