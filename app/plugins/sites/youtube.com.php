					...
					if( $data = json_decode( $data ) ):
						if( isset( $data->entry->title ) ):
							...
							if( $title ):
								...
								$return = array(
									true, //success ?
									'<iframe class="youtube_video" src="http://www.youtube.com/embed/' . $id . '" frameborder="0" allowfullscreen></iframe>', //desc
									'<iframe class="youtube_video" src="http://www.youtube.com/embed/' . $id . '" frameborder="0" allowfullscreen></iframe>', //summary
									$title, //title
