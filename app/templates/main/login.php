...
<body id="body_login">
	<div id="login">
		...
		<div id="buttons">
			...
			<a class="login" href="#"><img src="<?php echo $c_config['root']; ?>/inc/img/login/google.png" /> <strike>Login with Google</strike></a>
			<a class="login" href="#"><img src="<?php echo $c_config['root']; ?>/inc/img/login/steam.png" /> <strike>Login with Steam</strike></a>
			<a class="login" href="#"><img src="<?php echo $c_config['root']; ?>/inc/img/login/yahoo.png" /> <strike>Login with Yahoo</strike></a>
			<a class="login" href="#"><img src="<?php echo $c_config['root']; ?>/inc/img/login/openid.png" /> <strike>Login with OpenID</strike></a>
		</div><!--end buttons-->
	</div><!--end login-->
</body>
</html>